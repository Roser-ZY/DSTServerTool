---
name: {TOPIC}-autonomous-instruction
...
> **使用方式**: 提供"开发输入要求"中的必填信息后，配合 `using-sdd-workflow` SKILL 即可独立推进 Spec 开发
...
> 如果创建 instruction 时未提供"未来开发所需信息"，则本章节可省略或标注为"无特殊输入要求，按需提供开发需求描述即可"。
