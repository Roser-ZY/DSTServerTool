# Capability Spec: Steam Path Detection

## Purpose

Define end-to-end detection and validation of Steam path candidates for DST workflows, including auto-detection, manual validation, and retry behavior.
