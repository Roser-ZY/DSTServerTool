# Capability Spec: Steam Root Validation

## Purpose

Define platform-aware rules that distinguish real Steam roots from lookalike directories during automatic probing and manual path validation.
